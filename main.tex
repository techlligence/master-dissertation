...
\titlepage % Output the title page
	...
	{ % Title(s) and author(s)
		...
		\emph{Supervisor:} \\
		\href{http://www.jamessmith.com}{Duncan Anthony Coulter} \\ % Supervisor name - remove the \href bracket to remove the link  
		\emph{Co-supervisor:} \\
		\href{http://www.jamessmith.com}{Daniel Ogwok}
		\end{flushright}
		\end{minipage}\\[1cm]

		\large \textit{A dissertation submitted in fulfillment of the requirements\\ for the degree of Msc in Computer Science}\\[0.3cm] % University requirement text
		\textit{in the}\\[0.4cm]
